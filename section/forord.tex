...
\begin{tabular}{l p{0.6\linewidth}}
	...
	\textbf{Fed tekst}				& Bruges til at fremhæve produkt eller system specifikke betegnelser.\\
	\verb|Konstant bred tekst|	& Anvendes til kildekode eksempler. Ligeledes anvendes afgrænsende områder.\\
	\emph{Fremhævet tekst}		    & Bliver brugt når der gives en kort introduktion til hvert kapitel.\\
\end{tabular}

\subsection{Typografi}
Rapporten har en opbygning, der gør den behagelig at læse og indeholder derfor mange tomme sider.
